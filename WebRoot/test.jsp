			...
			<form class="standardForm" method="post">    
    			...
    			<ul>        
            		<li>
                		<h3><label for="boardEditName" class="hasError">Name</label></h3>                
               	    	<div>
                    		<input id="boardEditName" name="name" type="text" autofocus="" placeholder="Like “Places to Go” or “Recipes to Make.”" value="" class="hasError"><p class="formErrorMessage">Don't forget to name your board!</p>
                		</div>
           	    	</li>  
           	    	<li class="Wrapper">
    			...
    			<div class="formFooter">
        			<div class="formFooterButtons">
            			...
            			<button class="Button Module btn hasText primary rounded saveBoardButton disabled" type="submit" disabled="">
